...
function PopularTVCarousel({ tvShows }) {
    ...
    <div className="relative">
      ...
      >
        {tvShows.map((tvShow, index) => {
          ...
          // TV show object for favorites - EXACTLY like movie object
          ...
          return (
            ...
            >
              ...
              >
                {/* TV show name and year banner - EXACTLY same as movies */}
                ...
                <div className="flex justify-between items-start">
                  {/* Rating badge with star - EXACTLY same as movies */}
                  ...
                  {/* Favorite heart button - EXACTLY same as movies */}
                  <button
                    onClick={(e) => {
                      e.preventDefault();
                      e.stopPropagation();

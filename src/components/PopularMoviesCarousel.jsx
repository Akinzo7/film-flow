...
function PopularMoviesCarousel({ movies }) {
      ...
      >
        {movies.map((movie, index) => {
          ...
          return (
            ...
            >
              {/* Ranking number for top 10 - Moved INSIDE the card */}
              ...
              {/* Movie card link - Same style as MovieCard */}
              <Link
                to={`/movie/${movie.id}`}
              ...
              >
                {/* Movie name and year banner - Like MovieCard */}
                ...
                <div className="flex justify-between items-start">
                  {/* Rating badge with star - Like MovieCard */}
                  ...
                  {/* Favorite heart button - Like MovieCard */}
                  <button
                    onClick={(e) => {
                      e.preventDefault();
                      e.stopPropagation();

...
function HomePage({ searchQuery }) {
  ...
  // URLs for sections
  const nowPlayingUrl = `https://api.themoviedb.org/3/movie/now_playing?api_key=${import.meta.env.VITE_TMDB_KEY}&page=1`;
  const popularMoviesWeekUrl = `https://api.themoviedb.org/3/trending/movie/week?api_key=${import.meta.env.VITE_TMDB_KEY}`;
  const popularTVWeekUrl = `https://api.themoviedb.org/3/trending/tv/week?api_key=${import.meta.env.VITE_TMDB_KEY}`;
  const upcomingMoviesUrl = `https://api.themoviedb.org/3/movie/upcoming?api_key=${import.meta.env.VITE_TMDB_KEY}&page=1`;
  const freeToWatchUrl = `https://api.themoviedb.org/3/discover/movie?api_key=${import.meta.env.VITE_TMDB_KEY}&with_watch_monetization_types=free&page=1`;
  const airingTodayUrl = `https://api.themoviedb.org/3/tv/airing_today?api_key=${import.meta.env.VITE_TMDB_KEY}&page=1`;
  ...
  if (expandedMovies.length > 0) {
    return <ExpandedSection movies={expandedMovies} title={expandedTitle} onBack={handleBack} />;
  }
      ...
      {isSearching ? (
        ...
        <>
          ...
          {popularMoviesWeekData?.results && (
            <div className="px-4 md:px-8 mt-8">
              <div className="flex justify-between items-center mb-4">
                <h2 className="text-2xl md:text-3xl font-bold">Top 10 Popular Movies This Week</h2>
                <button 
              ...
              <PopularMoviesCarousel movies={popularMoviesWeekData.results.slice(0, 10)} />
            </div>
          )}
          ...
          {popularTVWeekData?.results && (
            <div className="px-4 md:px-8 mt-8">
              <div className="flex justify-between items-center mb-4">
                <h2 className="text-2xl md:text-3xl font-bold">Top 10 Popular TV Shows This Week</h2>
                <button 
                  onClick={() => handleViewAll(
                    popularTVWeekData.results, 
              ...
              <PopularTVCarousel tvShows={popularTVWeekData.results.slice(0, 10)} />
            </div>
          )}
          ...
          {airingTodayData?.results && (
            <div className="px-4 md:px-8 mt-8">
              <div className="flex justify-between items-center mb-4">
                <h2 className="text-2xl md:text-3xl font-bold">TV Shows Airing Today</h2>
                <button 
                  onClick={() => handleViewAll(
                    airingTodayData.results, 
              ...
              <AiringTodayTVCarousel tvShows={airingTodayData.results.slice(0, 10)} />
            </div>
          )}
          ...
          {upcomingMoviesData?.results && (
            <div className="px-4 md:px-8 mt-8">
              <div className="flex justify-between items-center mb-4">
                <h2 className="text-2xl md:text-3xl font-bold">Upcoming Movies</h2>
                <button 
                  onClick={() => handleViewAll(
                    upcomingMoviesData.results, 
                    "Upcoming Movies"
              ...
              <UpcomingMoviesCarousel movies={upcomingMoviesData.results.slice(0, 10)} />
            </div>
          )}
          ...
          {freeToWatchData?.results && (
            <div className="px-4 md:px-8 mt-8">
              <div className="flex justify-between items-center mb-4">
                <h2 className="text-2xl md:text-3xl font-bold">Free Movies to Watch</h2>
                <button 
                  onClick={() => handleViewAll(
                    freeToWatchData.results, 
              ...
              <FreeToWatchCarousel movies={freeToWatchData.results.slice(0, 10)} />
            </div>
          )}
        </>
      )}
